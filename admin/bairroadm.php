            ...
            <div class="main-panel">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="header">
                                <h2 class="title">Controle de bairros</h2>
                            </div>
                            <div class="card">
                                <div class="content">
                                    <?php
                                    if (isset($_POST['opcao']) && isset($_POST['id'])) {
                                        foreach ($cd->buscar($_POST['id']) as $data) {
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-goup">
                                                    <label for="enome">Edite o Nome do Bairro</label>
                                                    <input class="form-control" type="text" required name="bairro" value="<?= $data['bnome'] ?>">
                                                </div>
                                                <br/>
                                                <button type="submit" class="btn btn-success btn-fill"><i class="pe-7s-diskette"></i> Salvar Bairro</button>
                                            </form>
                                            <?php
                                        }
                                    } else {
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-goup">
                                                <label for="enome">Nome do Bairro</label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="post">
                                                                ...
                                                                <button name="opcao" value="editar" class="btn btn-danger btn-fill" title="Editar"><i class="fa fa-edit"></i></button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                                    <?php
